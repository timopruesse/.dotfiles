...
| --- | --- | --- | --- |
| cheap | `committer`, `researcher`, `scout` | `haiku` | `kimi-k2.7-code` |
...
Pinned agents: `committer`, `researcher`, `scout`, `boba-watcher`, `pr-babysitter`, `pr-reviewer`, `scout-explain`, `sweep`, `worker`, `verifier`.
