...
| **live-install** | Internal **sync** adapter (not a public CLI): installs agents/commands/skills/hooks/rules and merges CLI prefs into `~/.cursor` (plus Claude skills) without replacing that tree. Always full after generate. |
