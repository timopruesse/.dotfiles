...
| **protocol** | Shared contract in `home/protocols/` — `HANDOFF-PROTOCOL` (spine + land path), `LOOP-PROTOCOL` (shepherd/hub loops), `AGENT-ROUTING` (hard must-nots; sync emits host adapters). |
